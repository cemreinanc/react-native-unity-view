...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                  react-native-unity-view
                   DESC
  s.homepage     = "https://github.com/cemreinanc/react-native-unity-view"
  s.license      = "MIT"
  # s.license    = { :type => "MIT", :file => "LICENSE" }
  s.authors      = { "Cemre Inanc" => "cemreinanc@gmail.com" }
  s.platforms    = { :ios => "9.0", :tvos => "10.0" }
  s.source       = { :git => "https://github.com/cemreinanc/react-native-unity-view.git", :tag => "#{s.version}" }
